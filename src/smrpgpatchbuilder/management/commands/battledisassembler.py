...
from randomizer.helpers.battletables import (
    Targets,
    targeting_table,
    Monsters,
    monsters_table,
...
spells_table = build_table(
    get_default_spells(None)
    + [
        ChestScrow(None),
        ChestFear(None),
        ChestMute(None),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if mode == "parse":
            ...
            print("from randomizer.helpers.battletables import Targets, Monsters")
