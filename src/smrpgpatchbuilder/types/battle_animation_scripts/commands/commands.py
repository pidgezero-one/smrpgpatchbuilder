...
from types.numbers import Int16, Int8, UInt16, UInt8, UInt4
from types.sprites.ids import TOTAL_SPRITES
...
from types.battle_animation_scripts.arguments import (
    BUTTON_PRESSED,
    FADE_2BPP_COMPLETE,
    FADE_4BPP_COMPLETE,
    FADE_IN_COMPLETE,
...
from types.battle_animation_scripts.arguments.types import (
    BattleTarget,
    BonusMessage,
    FlashColour,
    MaskEffect,
...
class SetAMEMToRandom(UsableAnimationScriptCommand, AnimationScriptAMEMCommand):
...
class ScreenEffect(UsableAnimationScriptCommand, AnimationScriptCommandNoArgs):
