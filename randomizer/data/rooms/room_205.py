...
room = Room(
    ...
    exit_fields=[
        MapExit(
            ...
            ne_sw_edge_active=False,
            byte_2_bit_2=True,
            destination=overworld_area_names.OW09_MUSHROOM_WAY,
            show_message=False,
            byte_2_bit_1=False,
            byte_2_bit_0=False,
        ),
        RoomExit(
            ...
            ne_sw_edge_active=False,
            byte_2_bit_2=False,
            destination=room_names.R204_MUSHROOM_WAY_AREA_02,
            show_message=False,
            dst_x=20,
            dst_y=37,
            dst_z=0,
    ...
    objects=[
        BattlePackNPC( # 0
            npc=<smrpgpatchbuilder.datatypes.levels.classes.NPC object at 0x106bfae50>,
