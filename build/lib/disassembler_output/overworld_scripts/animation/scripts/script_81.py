...
script = ActionScript([
	...
	A_VisibilityOn(),
	A_JmpIfBitSet(TEMP_7044_6, ["ACTION_81_set_sprite_sequence_4"]),
	A_PlaySound(sound=SO050_WATER_DROPLET, channel=4),
	A_SetSpriteSequence(index=10, is_sequence=True, looping=True, identifier="ACTION_81_set_sprite_sequence_4"),
	A_Pause(12),
