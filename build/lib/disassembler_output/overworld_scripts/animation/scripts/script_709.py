...
script = ActionScript([
	...
	A_JmpIfObjectWithinRange(comparing_npc=NPC_4, usually=0, tiles=3, destinations=["ACTION_709_set_bit_18"], identifier="ACTION_709_jmp_if_object_within_range_14"),
	A_JumpToHeight(24),
	A_Walk1StepSoutheast(),
	A_Jmp(["ACTION_709_jmp_if_object_within_range_14"]),
	A_SetBit(TEMP_7043_1, identifier="ACTION_709_set_bit_18"),
