...
script = ActionScript([
	A_ClearSolidityBits(bit_4=True, cant_walk_through=True, identifier="ACTION_755_clear_solidity_bits_0"),
	A_SetSpriteSequence(index=10, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	A_Pause(1),
	A_ShiftToXYCoords(x=27, y=51),
	...
	A_VisibilityOff(),
	A_Pause(48),
	A_Jmp(["ACTION_755_clear_solidity_bits_0"])
])
