...
script = ActionScript([
	A_SetSpriteSequence(index=9, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True, identifier="ACTION_332_set_sprite_sequence_0"),
	A_Pause(2),
	...
	A_Pause(2),
	A_Jmp(["ACTION_332_set_sprite_sequence_0"])
])
