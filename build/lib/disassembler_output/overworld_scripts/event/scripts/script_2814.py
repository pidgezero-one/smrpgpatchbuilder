...
script = EventScript([
	...
	RunBackgroundEvent(event_id=E2813_MUSHROOM_WAY_3_SUMMON_SPINYS, return_on_level_exit=True),
	RunBackgroundEvent(event_id=E2809_MUSHROOM_WAY_BOSS_THREATENS_YOU, return_on_level_exit=True, bit_6=True),
	Return()
])
