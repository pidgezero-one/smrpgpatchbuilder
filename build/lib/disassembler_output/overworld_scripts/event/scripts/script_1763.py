...
script = EventScript([
	JmpIfObjectNotInSpecificLevel(NPC_6, R318_LANDS_END_DESERT_AREA_02, ["EVENT_1763_run_event_as_subroutine_3"]),
	SetVarToConst(ACTIVE_NPC, 26),
	Jmp(["EVENT_1887_jmp_if_bit_set_4"]),
	RunEventAsSubroutine(E1544_SAND_WHIRLPOOL, identifier="EVENT_1763_run_event_as_subroutine_3"),
