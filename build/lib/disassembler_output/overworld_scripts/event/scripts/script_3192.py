...
script = EventScript([
	...
	ActionQueueSync(target=MEM_70A8, subscript=[
		A_ObjectMemorySetBit(arg_1=0x30, bits=[4], identifier="EVENT_3192_action_queue_4_SUBSCRIPT_object_memory_set_bit_0"),
		...
		A_JumpToHeight(56),
		A_Pause(32),
		A_Pause(1, identifier="EVENT_3192_action_queue_4_SUBSCRIPT_pause_10"),
		A_JmpIfBitClear(TEMP_7043_1, ["EVENT_3192_action_queue_4_SUBSCRIPT_pause_10"]),
		A_Pause(32),
	...
	SetBit(TEMP_7043_1),
	JmpIfBitSet(RUN_AWAY, ["EVENT_3192_close_dialog_13"]),
	...
	CloseDialog(identifier="EVENT_3192_close_dialog_13"),
