...
script = EventScript([
	JmpIfBitSet(TEMP_7044_5, ["EVENT_3596_run_event_as_subroutine_4"], identifier="EVENT_3596_jmp_if_bit_set_0"),
	...
	Return(),
	RunEventAsSubroutine(E0456_YOSHI_TALKS_TO_OTHER_YOSHI, identifier="EVENT_3596_run_event_as_subroutine_4"),
