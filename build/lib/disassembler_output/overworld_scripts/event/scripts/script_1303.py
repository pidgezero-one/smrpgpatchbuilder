...
script = EventScript([
	JmpIfBitSet(TEMP_7043_7, ["EVENT_1303_ret_11"], identifier="EVENT_1303_jmp_if_bit_set_0"),
	Pause(1),
	CreatePacketAtObjectCoords(packet=P034_GREY_EXPLOSION_SFX, target_npc=MARIO, destinations=["EVENT_1303_jmp_if_bit_set_0"]),
	ActionQueueSync(target=NPC_4, subscript=[
		A_TransferToXYZF(x=24, y=27, z=0, direction=EAST),
