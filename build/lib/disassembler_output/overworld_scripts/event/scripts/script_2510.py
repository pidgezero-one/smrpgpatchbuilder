...
script = EventScript([
	...
	ApplyTileModToLevel(use_alternate=True, room_id=R158_STAR_HILL_AREA_02, mod_id=1),
	Pause(1),
	UnknownCommand(bytearray(b'\xfd\x8d')),
	ApplyTileModToLevel(use_alternate=True, room_id=R158_STAR_HILL_AREA_02, mod_id=2),
	Inc(TEMP_70AE),
