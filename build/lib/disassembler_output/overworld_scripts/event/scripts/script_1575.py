...
script = EventScript([
	...
	UnknownCommand(bytearray(b'\xfd\x8d'), identifier="EVENT_1575_db_5"),
	ApplyTileModToLevel(use_alternate=True, room_id=R068_MIDAS_RIVER_BARREL_JUMPING_RIVER, mod_id=2),
	Return()
])
