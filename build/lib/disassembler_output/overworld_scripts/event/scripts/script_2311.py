...
script = EventScript([
	...
	ResetAndChooseGame(),
	RemoveObjectFromCurrentLevel(NPC_7, identifier="EVENT_2311_remove_from_current_level_5"),
	Store01To0248(),
	ApplyTileModToLevel(use_alternate=True, room_id=R100_BOOSTER_PASS_AREA_01, mod_id=2),
	Store00To0248(),
