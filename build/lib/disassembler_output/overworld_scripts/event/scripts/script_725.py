...
script = EventScript([
	...
	ActionQueueAsync(target=MARIO, subscript=[
		A_Pause(1, identifier="EVENT_725_action_queue_5_SUBSCRIPT_pause_0"),
		A_JmpIfMarioInAir(["EVENT_725_action_queue_5_SUBSCRIPT_pause_0"]),
		A_ClearSolidityBits(cant_pass_walls=True),
		A_ClearSolidityBits(bit_4=True, cant_pass_npcs=True, cant_walk_through=True, bit_7=True),
		A_FloatingOff(),
		A_WalkToXYCoords(x=21, y=122)
	]),
