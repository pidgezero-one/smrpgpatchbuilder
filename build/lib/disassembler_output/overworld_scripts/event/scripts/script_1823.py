...
script = EventScript([
	...
	Set7000ToCurrentLevel(identifier="EVENT_1823_set_7000_to_current_level_4"),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 321, ["EVENT_1823_ret_11"]),
	FreezeCamera(),
	...
	Return(identifier="EVENT_1823_ret_11")
])
