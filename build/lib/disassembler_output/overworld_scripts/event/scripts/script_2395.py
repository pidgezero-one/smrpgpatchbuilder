...
script = EventScript([
	JmpIfBitSet(CASINO_WARP_DIRECTIONAL_BIT, ["EVENT_2395_ret_14"]),
	...
	ActionQueueSync(target=NPC_3, subscript=[
		...
		A_ShiftToXYCoords(x=3, y=107),
		A_Pause(24),
		A_ShiftToXYCoords(x=0, y=0)
	]),
	ActionQueueSync(target=MARIO, subscript=[
		A_Pause(1, identifier="EVENT_2395_action_queue_5_SUBSCRIPT_pause_0"),
		A_JmpIfMarioInAir(["EVENT_2395_action_queue_5_SUBSCRIPT_pause_0"]),
		A_ReturnQueue()
	]),
	...
	AddToInventory(LazyShellItem2),
	Pause(1, identifier="EVENT_2395_pause_12"),
	JmpIfObjectActionScriptIsRunning(MARIO, ["EVENT_2395_pause_12"]),
	Return(identifier="EVENT_2395_ret_14")
])
