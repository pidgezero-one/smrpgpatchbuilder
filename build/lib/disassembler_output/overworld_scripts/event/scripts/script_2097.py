...
script = EventScript([
	...
	JmpIfBitSet(TEMP_7043_3, ["EVENT_2097_set_action_script_4"]),
	SetSyncActionScript(NPC_0, A0866_MOVE_HINOPIO_TO_ITEM_SHOP),
	Return(),
	SetSyncActionScript(NPC_0, A0868_MOVE_HINOPIO_TO_ITEM_SHOP, identifier="EVENT_2097_set_action_script_4"),
	Return(),
