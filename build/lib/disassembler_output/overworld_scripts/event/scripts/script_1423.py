...
script = EventScript([
	...
	JmpIfBitClear(TOAD_IN_MUSHROOM_WAY_1, ["EVENT_1423_remove_from_current_level_7"]),
	...
	Return(),
	RemoveObjectFromCurrentLevel(NPC_7, identifier="EVENT_1423_remove_from_current_level_7"),
