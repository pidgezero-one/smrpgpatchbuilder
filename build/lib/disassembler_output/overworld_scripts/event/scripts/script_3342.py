...
script = EventScript([
	JmpIfBitSet(VOLCANO_STAIRCASE_ANIMATION_COMPLETED, ["EVENT_3342_run_event_as_subroutine_2"]),
	ActionQueueSync(target=NPC_3, subscript=[
		A_TransferXYZFSteps(x=0, y=0, z=8, direction=EAST)
	]),
	RunEventAsSubroutine(E0015_STANDARD_ROOM_LOADER, identifier="EVENT_3342_run_event_as_subroutine_2"),
