...
script = EventScript([
	...
	ActionQueueAsync(target=NPC_3, subscript=[
		A_TransferXYZFPixels(x=8, y=6, z=0, direction=EAST)
	]),
	FadeInFromBlack(sync=False),
	RunBackgroundEvent(event_id=E3697_NIMBUS_CASTLE_WEST_LOWER_HALL_PINWHEEL_ANIMATIONS, return_on_level_exit=True),
	Return()
])
