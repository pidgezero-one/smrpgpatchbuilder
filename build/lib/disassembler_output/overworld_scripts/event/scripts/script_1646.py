...
script = EventScript([
	...
	Return(),
	RunDialog(dialog_id=DI1142_MOLEVILLE_BLUES_HINT, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_1646_run_dialog_3"),
	Return()
])
