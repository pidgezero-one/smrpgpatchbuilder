...
script = EventScript([
	...
	ActionQueueAsync(target=MARIO, subscript=[
		A_Pause(1, identifier="EVENT_2525_action_queue_3_SUBSCRIPT_pause_0"),
		A_JmpIfMarioInAir(["EVENT_2525_action_queue_3_SUBSCRIPT_pause_0"]),
	...
	EnterArea(room_id=R159_STAR_HILL_AREA_04, face_direction=SOUTHWEST, x=26, y=110, z=2, run_entrance_event=True),
	Return()
])
