...
script = EventScript([
	...
	JmpIfBitSet(TEMP_7043_2, ["EVENT_2099_set_action_script_4"]),
	SetSyncActionScript(NPC_0, A0865_MOVE_HINOPIO_TO_ARMOR_SHOP),
	Return(),
	SetSyncActionScript(NPC_0, A0867_MOVE_HINOPIO_TO_ARMOR_SHOP, identifier="EVENT_2099_set_action_script_4"),
	Return(),
