...
script = EventScript([
	JmpIfBitSet(RUN_AWAY, ["EVENT_25_set_temp_action_script_3"]),
	JmpIfBitSet(GAME_OVER, ["EVENT_24_reset_and_choose_game_17"]),
	Jmp(["EVENT_24_jmp_if_bit_clear_2"]),
	SetTempSyncActionScript(MEM_70A8, A0284_IFRAME_BLINK, identifier="EVENT_25_set_temp_action_script_3"),
