...
script = EventScript([
	...
	JmpIfBitClear(UNUSED_7086_4, ["EVENT_3507_set_var_to_const_0"]),
	JmpIfBitClear(UNUSED_7086_3, ["EVENT_3507_set_var_to_const_0"]),
	JmpIfBitSet(UNUSED_704E_1, ["EVENT_3507_set_var_to_const_0"]),
	...
	], identifier="EVENT_3508_action_queue_14"),
	JmpIfBitSet(TEMP_7044_2, ["EVENT_3508_set_var_to_const_17"]),
	ActionQueueAsync(target=MARIO, subscript=[
		A_SetAllSpeeds(FAST),
	...
	SetVarToConst(TEMP_70AE, 3, identifier="EVENT_3508_set_var_to_const_17"),
	...
	Pause(16),
	JmpIfBitSet(TEMP_7044_2, ["EVENT_3508_play_sound_33"]),
	...
	PlaySound(sound=SO087_CORRECT_SIGNAL, channel=6, identifier="EVENT_3508_play_sound_33"),
	RunDialog(dialog_id=DI1191_EMPTY, above_object=NPC_12, closable=False, sync=False, multiline=True, use_background=False),
	JmpIfDialogOptionBSelected(["EVENT_3508_run_dialog_duration_54"]),
	...
	JmpToSubroutine(["EVENT_3508_action_queue_80"]),
	ActionQueueAsync(target=MARIO, subscript=[
		A_Pause(36),
	...
	RunDialogForDuration(dialog_id=DI1192_EMPTY, duration=0, sync=False),
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_JumpToHeight(height=108, silent=True),
		A_WalkNorthwestPixels(32),
		A_Pause(1, identifier="EVENT_3508_action_queue_50_SUBSCRIPT_pause_8"),
		A_JmpIfMarioInAir(["EVENT_3508_action_queue_50_SUBSCRIPT_pause_8"]),
		A_JumpToHeight(height=108, silent=True),
		A_Pause(5)
	]),
	ActionQueueSync(target=NPC_7, subscript=[
		...
		A_EndLoop(),
		A_Pause(73),
		A_TransferToXYZF(x=6, y=57, z=5, direction=EAST),
		A_VisibilityOn(),
		A_SetSpriteSequence(index=1, is_sequence=True, looping=True, mirror_sprite=True)
	]),
	ActionQueueSync(target=NPC_4, subscript=[
	...
	RunDialogForDuration(dialog_id=DI1187_EMPTY, duration=1, sync=False, identifier="EVENT_3508_run_dialog_duration_54"),
	...
	SetVarToConst(TIMER_701E, 400),
	RunBackgroundEventWithPauseReturnOnExit(event_id=E1551_BANK_1F_RETURN_EVENT, timer_var=TIMER_701E, bit_4=True, bit_5=True),
	SetSyncActionScript(NPC_7, A0352_EMPTY),
	...
	ActionQueueSync(target=NPC_0, subscript=[
		...
		A_PlaySound(sound=SO049_BIG_SHELL_HIT, channel=4),
		A_VisibilityOn(),
		A_JumpToHeight(24, identifier="EVENT_3508_action_queue_80_SUBSCRIPT_jump_to_height_9"),
		A_Walk1StepSoutheast(),
		A_Set700CToObjectCoord(target_npc=DUMMY_0X07, coord=COORD_X, pixel=True),
		A_CompareVarToConst(PRIMARY_TEMP_700C, 5888),
		A_JmpIfComparisonResultIsLesser(["EVENT_3508_action_queue_80_SUBSCRIPT_jump_to_height_9"])
	], identifier="EVENT_3508_action_queue_80"),
	ActionQueueSync(target=NPC_3, subscript=[
		A_Pause(50),
		A_JumpToHeight(112)
	]),
