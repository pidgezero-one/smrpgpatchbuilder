...
script = EventScript([
	JmpIfBitSet(UNUSED_7061_0, ["EVENT_576_set_var_to_const_6"]),
	JmpIfObjectInSpecificLevel(NPC_4, R093_ROSE_TOWN_DURING_BOWYER_TREASURE_HOUSE_1F, ["EVENT_576_set_var_to_const_6"]),
	...
	Return(),
	SetVarToConst(ITEM_ID, DebugBombItem, identifier="EVENT_576_set_var_to_const_6"),
