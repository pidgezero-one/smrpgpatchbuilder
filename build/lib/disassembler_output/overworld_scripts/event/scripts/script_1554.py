...
script = EventScript([
	...
	UnfreezeCamera(),
	UnfreezeAllNPCs(),
	Jmp(["EVENT_1554_set_var_to_const_11"]),
	FadeInFromBlack(sync=True, identifier="EVENT_1554_fade_in_from_black_sync_10"),
	SetVarToConst(TEMP_70A9, 20, identifier="EVENT_1554_set_var_to_const_11"),
	StartLoopNTimes(3),
	...
	RunBackgroundEvent(event_id=E1555_FOREST_FIRST_WIGGLER_ROOM_LOADER_CONTD, return_on_level_exit=True),
	Return()
])
