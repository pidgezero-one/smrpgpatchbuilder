...
script = EventScript([
	JmpIfBitSet(GARRO_SEQUENCE_COMPLETED, ["EVENT_3642_jmp_if_bit_clear_2"]),
	ApplySolidityModToLevel(permanent=True, room_id=R416_NIMBUS_LAND_OUTSIDE_BEFORE_VALENTINA, mod_id=0),
	JmpIfBitClear(NIMBUS_MID_BOSS_COMPLETED, ["EVENT_3642_set_temp_action_script_5"], identifier="EVENT_3642_jmp_if_bit_clear_2"),
	ClearBit(TEMP_704C_0),
	ClearBit(GUEST_DROPPED_OFF),
	SetTempAsyncActionScript(NPC_5, A0804_INC_PALETTE_ROW_15, identifier="EVENT_3642_set_temp_action_script_5"),
