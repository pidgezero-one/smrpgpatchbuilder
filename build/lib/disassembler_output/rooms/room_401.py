...
room = Room(
    ...
    events=[
        Event(
            event=E1819_SHY_AWAY_EARLY_LANDS_END,
            x=29,
            y=37,
            z=0,
        ...
        Event(
            event=E1851_LANDS_END_GROTTO_DIRECTIONAL_BIT,
            x=20,
            y=39,
            z=5,
            f=EdgeDirection.SOUTHEAST,
    ...
    exits=[
        RoomExit(
            ...
            ne_sw_edge_active=False,
            byte_2_bit_2=False,
            destination=R270_LANDS_END_SECRET_UNDERGROUND_AREA_01_LEADS_TO_KERO_SEWERS,
            show_message=False,
            dst_x=21,
            dst_y=70,
            dst_z=0,
